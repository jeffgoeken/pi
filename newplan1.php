...
<span id="myspan">myspan</div>
<div id="demo"></div>
</fieldset></form>
<fieldset><legend>Plan Settings</legend>
<div id="plansettings"></div>
</table>
<input type="button" class="btn btn-primary" value="Add Row" onclick="start()">
</fieldset>
...
function inittable(){
  ...
  content +='<th>Time</th></tr><tr><th>Event' + e + '<th>'
 for (i=1;i<17;i++){
   content += '<td><input type="checkbox" value="true" class="checkbox" name="event' + e +'"/></td>';
   }//end checkbox loop
   content += '<td><input type"text"></td></tr></table>'
